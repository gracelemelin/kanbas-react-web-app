    ...
    return (
        <div>
            ...
            <input type="number" value={a}
                onChange={(e: any) => setA(e.target.value)} /> <br />
            <input type="number"
                onChange={(e: any) => setB(e.target.value)} value={b} /> <br />
            ...
            <br />
            <a className="btn btn-primary mt-2" href={`${API_BASE}/a5/multiply/${a}/${b}`}>
                Multiply {a} * {b}
            </a>

            <a className="btn btn-danger mt-2" href={`${API_BASE}/a5/divide/${a}/${b}`}>
                Divide {a} / {b}
            </a>
